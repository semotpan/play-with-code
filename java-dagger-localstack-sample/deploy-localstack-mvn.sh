...
aws --profile localstack --endpoint-url=http://localhost:4566 cloudformation deploy --template-file out.yml --stack-name product-lambda-sample --capabilities CAPABILITY_NAMED_IAM
